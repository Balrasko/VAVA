...
//             FinanceReport rangeReport = financeDao.getFinanceReport(effectiveFrom, effectiveTo);
//             financeItems.clear();
//             financeItems.addAll(rangeReport.items());
//             sortItems();
//             dailySalesLabel.setText(formatDecimal(rangeReport.dailySales()));
//             soldItemsTotalLabel.setText(String.valueOf(rangeReport.soldItemsTotal()));
...
//             writer.newLine();
//             writer.newLine();
//             writer.write("item_id,name,category,sold_pieces,price_per_piece");
//             writer.newLine();
...
//                         financeItems.stream()
//                                 .map(FinanceItemReport::categoryName)
...
//         return financeItems.stream()
//                 .filter(item -> activeSearchPattern == null || matchesSearch(item))
//                 .filter(item -> !filterCategory || selectedCategory.equals(item.categoryName()))
//                 .toList();
//     }
