...
public class UserSessionDao {
    public Optional<UserSession> findByUserId(long userId) {
        String sql =
                "SELECT id, user_id, login_time, logout_time, created_at, updated_at FROM user_sessions WHERE user_id = ?";
    ...
    public UserSession create(int userId) {
        String sql =
                "INSERT INTO user_sessions (user_id, login_time, created_at, updated_at) VALUES (?, NOW(), NOW(), NOW()) RETURNING id, user_id, login_time, logout_time, created_at, updated_at";
    ...
    public boolean close(long id) {
        String sql =
                "UPDATE user_sessions SET logout_time = NOW(), updated_at = NOW() WHERE id = ? AND logout_time IS NULL";
